...
private:
	...
	bool isDeviceSuitable(VkPhysicalDevice device)
	{
		...
		return qfi.isComplete() && extensionsSupported && swapChainAdequate;
	}
	...
	{
		auto vertShaderCode = readFile("../shaders/simple_triangle/triangle.vert.spv");
		auto fragShaderCode = readFile("../shaders/simple_triangle/triangle.frag.spv");
	...
	void updateUniformBuffer()
	{
		...
		ubo.proj[1][1] *= -1; // the y-axis of clip space in Vulkan is pointing down in contrary to OpenGL
